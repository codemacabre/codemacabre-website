...
- [calibre](https://calibre-ebook.com/download_linux) to manage my ebooks
- [kew](https://github.com/ravachol/kew?tab=readme-ov-file#installing) terminal music player to play my locally-downloaded MP3s 
...
- [WeeChat](https://weechat.org/download/debian/) terminal IRC client
- Xfce Terminal (already installed), along with [ZSH](https://github.com/ohmyzsh/ohmyzsh/wiki/Installing-ZSH#install-and-set-up-zsh-as-default) and [Oh My ZSH!](https://github.com/ohmyzsh/ohmyzsh?tab=readme-ov-file#basic-installation) with the [Spaceship prompt](https://github.com/spaceship-prompt/spaceship-prompt?tab=readme-ov-file#-installation) and the [`zsh-autosuggestions`](https://github.com/zsh-users/zsh-autosuggestions/blob/master/INSTALL.md#oh-my-zsh) and [`zsh-syntax-highlighting`](https://github.com/zsh-users/zsh-syntax-highlighting/blob/master/INSTALL.md#oh-my-zsh) add-ons
